...
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '괌 4~6일 #츠바키타워 #6성급 #괌최신상호텔 #인피니티풀', 4, 
		to_date('2023-04-24', 'YYYY-MM-DD'),
		800000, '', '2020년 새롭게 오픈한 괌 최초 6성급 호텔로, 태평양의 환상적인 뷰를 감상할 수 있는 전객실 오션뷰를 자랑하는 괌 최고의 럭셔리 호텔입니다.',
		3);
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '괌 4~6일 #두짓비치리조트 #투몬시내중심 #레노베이션', 4, 
		to_date('2023-04-24', 'YYYY-MM-DD'),
...
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '규슈 3~4일 #100%출발확정', 4, 
...
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '규슈 3~4일 #홈쇼핑따라잡기', 4, 
		to_date('2023-04-29', 'YYYY-MM-DD'),
...
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '규슈/우레시노온천/아소온천 3~4일 #베스트셀러', 4, 
		to_date('2023-04-29', 'YYYY-MM-DD'),
		900000, '', '매끄러운 온천수 덕분에 이곳에서 온천을 하면 미인이 된다는 유래가 있는 우레시노는 미인온천으로 유명한 곳 입니다. 고즈넉한 일본 감성이 넘치는 우레시노 마을은 특히 현지인들에게도 사랑받는 곳 입니다.',
		1);		
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '규슈 3~4일 #열차여행 #온천여행 #알찬일정', 4, 
		to_date('2023-04-29', 'YYYY-MM-DD'),
		750000, '', '규슈의 핵심 관광지를 두루 돌아보며 호텔에서 온천욕을 즐기고, 기차를 탑승해볼 수 있는 특별한 경험을 할 수 있습니다. 관광과 힐링, 이 두 가지를 모두 만족시킬 수 있는 상품입니다. 가족동반 고객분들에게 추천 드립니다.',
		1);		
insert into tourinfo(tour_code, tour_name, tour_days, dep_day,
	base_price, conductor, tour_abs, accom_code)
values 
	(tour_seq.nextval, '_규슈/구마모토 3~4일', 4, 
		to_date('2023-04-29', 'YYYY-MM-DD'),
		690000, '', '구마모토공항을 왕복으로 이용하면서 더 편안한 동선으로 즐길 수 있는 북규슈 여행상품입니다.',
		1);																		
